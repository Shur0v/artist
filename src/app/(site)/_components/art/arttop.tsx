...
const artworkData: ArtworkData[] = [
  ...
  },
  {
    ...
    description:
      "Watercolor Ink, and Pencilon paper. 20.4/8X20.4/8. Prints available",
  },
  {
    id: 13,
    image: "/latest/8.jpg",
  ...
  },
  {
    ...
    description:
      "Gouache, watercolor, pencil, ink on paper.32x25. Prints available",
  },
  {
    id: 22,
    image: "/latest/20.jpg",
      ...
      <div className="container">
        <div className="content">
              ...
              <div className="col-span-5">
                <div className="right flex my-6 md:m-0 flex-col gap-4">
                  ...
                  <p className="text-start text-sm font-normal leading-none ">
                    Photo by <span className="font-bold">Amanda Ovena</span>{" "}
                    2025.
                  </p>
                </div>
              </div>
          ...
          <div className="pb-5 border-b-2 border-color2 w-full inline-flex justify-start items-center gap-2.5">
            <div className="justify-start text-color2 text-[30px] md:text-[40px] font-medium leading-[1.2]">
              Fine Art Portfolio
            </div>
          </div>
              ...
              <div className="flex flex-col items-center w-[80vw]">
                ...
                <div className="w-full text-center p-4 mt-4">
                  <h3 className="text-white text-xl font-medium">
                    {
                      artworkData.find((art) => art.image === selectedImage)
                        ?.title
                    }
                  </h3>
          ...
          <div className="text-center text-color5 text-sm font-normal mt-12">
            {" "}
            Art Photography by{" "}
            <span className="font-bold">The Color Group</span>{" "}
          </div>
        </div>
      </div>
    </div>
