        ...
        <div className="content">
          ...
          <div className="flex flex-col gap-10">
            ...
            <button 
              ...
              className="h-11 px-8 py-4 bg-[#ff6b00] rounded-[22px] inline-flex justify-center items-center gap-3 cursor-pointer hover:bg-[#e65600] transition-colors duration-300 self-center"
            >
              <div className="text-[#fff9eb] text-base font-medium leading-none">
