...
<div className="flex flex-col justify-start items-center gap-6 mb-[60px]">
  <div className="px-6 py-2.5 border-b-2 border-[#ff6b00] flex justify-center items-center gap-3">
    <div className="justify-center text-[#ff6b00] text-base font-normal leading-none"> </div>
  </div>
...
<div className="content md:grid grid-cols-12 gap-[60px] justify-between">
  ...
  <div className="col-span-7 flex flex-col justify-start items-start gap-7">
    <div className="w-full md:w-[640px] justify-center text-[#4a4c56] text-base font-normal font-['Poppins'] leading-relaxed">
    ...
    <div className="w-full flex flex-col justify-start items-start gap-8">
      <div className="w-full flex flex-col justify-start items-start gap-4">
        <div className="h-[23px] inline-flex justify-start items-center gap-2">
          <div className="justify-start text-[#4a4c56] text-lg font-medium font-['Poppins'] leading-normal">About the poet</div>
          <div className="w-[63px] h-0 outline-[1.50px] outline-offset-[-0.75px] outline-[#ff6b00]"></div>
        </div>
        <div className="w-full justify-center text-[#4a4c56] text-base font-normal font-['Poppins'] leading-relaxed">
      ...
      <div className="w-full flex flex-col md:flex-row justify-start items-start md:items-center gap-6">
        <div className="w-full md:w-auto px-7 py-2.5 bg-[#272727] rounded-xl flex justify-start items-center gap-3">
